...
void setup(void)
{
  ...
  doc["node_0"]["temperature"]= temp_0;
  doc["node_0"]["pH"] = phValue_0;
  doc["node_0"]["dissolved_oxygen"] = DO_0;
  
  
  doc["node_1"]["temperature"] = temp_1;
  doc["node_1"]["pH"] = phValue_1;
  doc["node_1"]["dissolved_oxygen"] = DO_1;
}
